...
> **Status: v0.4.16 — live-validated and hardened.** All four capability planes were
...
> pinned to `^1.17.0` (D1), and CI runs the real build **plus a 109-test host suite
