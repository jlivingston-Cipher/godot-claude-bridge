...
editor, Godot's own LSP + DAP, and a runtime bridge inside the running game. **282 tools
+ 6 MCP resources**, built against the stable `@modelcontextprotocol/sdk` 1.x API.
